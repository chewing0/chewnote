...
class LLMClient:
    def __init__(self) -> None:
        ...
        self.base_url = os.getenv("OPENAI_BASE_URL", "https://api.moonshot.cn/v1").rstrip("/")
        self.model = os.getenv("OPENAI_MODEL", "moonshot-v1-8k")
    ...
    async def parse(self, text: str, history: list[dict[str, str]] | None = None) -> dict[str, Any]:
